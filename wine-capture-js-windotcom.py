...
def get_100_wine(i):
    url1 = 'https://www.wine.com/list/wine/france/red-wine/james-suckling/vintage-2018/7155-107033-124-208-383'
    url2 = '?sortBy=priceHighToLow&showOutOfStock=true'
    url3 = '/'
    ...
    wine_col1 = 0
    count = 0
    worksheet = workbook.add_sheet('js2018索引')
        ...
        for wine1 in div_all1:
            ...
            for wine2 in div_all2:
                ...
                if div_rate2.text == 'WS':
                    ...
                    worksheet.write(wine_col0 + count, 9, div_rate3.text)
    ...
    workbook.save('wine-js-2018.xls')
    print('您的文件： wine-js-2018.xls 已经成功生成')
...
def main():
    url = 'https://www.wine.com/list/wine/france/red-wine/wine-spectator/vintage-2018/7155-107033-124-202-383?sortBy=priceHighToLow&showOutOfStock=true'
