...
def get_2018_wine():
        file_name = 'farr-2019-list-fqdn.xls'
        ...
        for i in range(0, target_table.nrows):
            ...
            for i in div_sub:
                ...
                try:
                    ...
                    if div_name_sum == 'Thomas Parker MW, Farr Vintners, November 2021':
                    ...
                    elif div_name_sum == 'Neal Martin, vinous.com, February 2022':
                        print(div_name_farr_con)
                        print(div_farr_point)
                    ...
                    elif div_name_sum == 'James Suckling, JamesSuckling.com, January 2022':
                        print(div_name_farr_con)
                        print(div_farr_point)
                    ...
                    elif div_name_sum == 'Antonio Galloni, vinous.com, February 2022':
                        print(div_name_farr_con)
                        print(div_farr_point)
                        sheet.write(row, 11, div_farr_point)
                    elif div_name_sum == 'Jane Anson, JaneAnson.com, January 2022':
                        print(div_name_farr_con)
                        print(div_farr_point)
        ...
        writebook.save('farr2019-2022-new.xlsx')
