        ...
        for i in range(0, target_table.nrows):
            ...
            for i in div_sub:
                ...
                try:
                    ...
                    if div_name_sum == 'Farr Vintners, Farr Tasting, April 2019':
                        print(div_name_farr_con)
                        print(div_farr_point)
                        sheet.write(row, 3, div_farr_point)
                    elif div_name_sum == 'Neal Martin, vinous.com, November 2019':
                        print(div_name_farr_con)
                        print(div_farr_point)
                    ...
                    elif div_name_sum == 'Lisa Perrotti-Brown MW, Wine Advocate (April 2019), April 2019':
                        print(div_name_farr_con)
                        print(div_farr_point)
                    ...
                    elif div_name_sum == 'James Suckling, JamesSuckling.com, April 2019':
                        print(div_name_farr_con)
                        print(div_farr_point)
                    ...
                    elif div_name_sum == 'Antonio Galloni, vinous.com, May 2019':
                        print(div_name_farr_con)
                        print(div_farr_point)
                    ...
                    elif div_name_sum == 'Jane Anson, Decanter.com, April 2019':
                        print(div_name_farr_con)
                        print(div_farr_point)
