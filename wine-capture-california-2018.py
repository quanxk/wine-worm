...
def get_100_wine(i):
    url1 = 'https://www.wine.com/list/wine/california/red-wine/vintage-2018/7155-106870-124-383'
    ...
    wine_col1 = 0
    count = 0
    worksheet = workbook.add_sheet('CA2018索引')
    ...
    workbook.save('wine-california-2018.xls')
    print('您的文件： wine-california-2018.xls 已经成功生成')
