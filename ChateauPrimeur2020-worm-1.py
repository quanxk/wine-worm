...
def get_2020_point(wine_url_list):
    row = 1
    ...
    writebook.save('chateau-primeur-2020.xlsx')


def main():

    root_2020_url = 'https://www.chateauprimeur.com/catalogue/tous/2020?url=catalogue%2Ftous%2F2020&notes=&page='
    get_2020_point(get_2020_wine(root_2020_url))
