...
def get_100_wine(i):
    url1 = 'https://www.wine.com/list/wine/france/red-wine/wine-spectator/vintage-2018/7155-107033-124-202-383'
    ...
    wine_col1 = 0
    count = 0
    worksheet = workbook.add_sheet('ws2018索引')
    ...
    workbook.save('wine-ws.xls')
    print('您的文件： wine-ws.xls 已经成功生成')
